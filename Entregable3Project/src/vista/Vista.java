...
public class Vista extends JFrame {
	...
	public Vista() {
		...
		identificadoresDePaneles.put("KIdMenuInicio", "MenuInicio");
		identificadoresDePaneles.put("KIdMenuRegistracion", "MenuRegistracion");
		identificadoresDePaneles.put("KIdMenuCompra", "MenuCompra");
		identificadoresDePaneles.put("KIdMenuCotizaciones", "MenuCotizaciones");
		identificadoresDePaneles.put("KIdMenuMisActivos", "MenuMisActivos");
		identificadoresDePaneles.put("KIdMenuMisOperaciones", "MenuMisOperaciones");
		...
		cardLayout.show(panelPrincipal, identificadoresDePaneles.get("KIdMenuInicio"));
	}
}
